...
public class UserController {
  ...
  @Operation(
      ...
      description = "Actualiza los datos del usuario autenticado, incluyendo avatar"
  )
  @PutMapping(value = "/me", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
  public ResponseEntity<UserResponse> updateCurrentUser(
      @Parameter(description = "Nombre de usuario (opcional)")
      @RequestPart(value = "username", required = false) String username,
      @Parameter(description = "Email del usuario (opcional)")
      @RequestPart(value = "email", required = false) String email,
      @Parameter(description = "Nombre del canal (opcional)")
      @RequestPart(value = "channelName", required = false) String channelName,
      @Parameter(description = "Imagen de avatar (opcional)")
